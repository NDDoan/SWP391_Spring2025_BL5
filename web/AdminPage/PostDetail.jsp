...
<html>
    <head>
        ...
        <title>
            <c:choose>
                <c:when test="${mode == 'create'}">Thêm Bài Đăng mới</c:when>
                <c:when test="${mode == 'edit'}">Sửa Bài Đăng</c:when>
                <c:otherwise>Xem Bài Đăng</c:otherwise>
            </c:choose>
        </title>
        <!-- Bootstrap CSS -->
                ...
                <div class="container mt-4">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h2>
                                <c:choose>
                                    <c:when test="${mode == 'create'}"><i class="fas fa-plus-circle"></i> Thêm Bài Đăng Mới</c:when>
                                    <c:when test="${mode == 'edit'}"><i class="fas fa-edit"></i> Sửa Bài Đăng</c:when>
                                    <c:otherwise><i class="fas fa-eye"></i> Xem Bài Đăng</c:otherwise>
                                </c:choose>
                            </h2>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <c:if test="${mode != 'view'}">
                                                        ...
                                                        <small class="form-text text-muted">Kích thước khuyến nghị: 1200x630 pixels, tối đa 2MB</small>
                                                    </c:if>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <small class="text-muted">Các bài đăng đang hoạt động sẽ hiển thị cho người dùng</small>
                                                </div>
                                                ...
                                                <c:if test="${post != null}">
                                                    <div class="created-info">
                                                        ...
                                                        <p><strong>Tạo ra vào lúc:</strong> <fmt:formatDate value="${post.createdAt}" pattern="dd-MM-yyyy HH:mm" /></p>
                                                    </div>
                                                </c:if>
                                            </div>
                                        </div>
