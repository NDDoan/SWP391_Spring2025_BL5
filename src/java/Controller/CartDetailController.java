...
public class CartDetailController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userId == null) {
            response.sendRedirect(request.getContextPath() + "/logincontroller"); // hoặc về trang đăng nhập
            return;
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        cartDao.addCartItem(cartId, productId, quantity,0);  // Gọi DAO để thêm vào CSDL
